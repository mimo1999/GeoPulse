...
def main():
    ...
    if retrieved:
        ...
        st.caption(
            f"Top-{len(retrieved)} profiles retrieved by TF-IDF cosine similarity "
            f"— synthetic templates unless marked • historical"
        )
        ...
        for ctx in retrieved:
            ...
            # Distinguish real historical events from synthetic seed templates
            if source == "ucdp_ged":
